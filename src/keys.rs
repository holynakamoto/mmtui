...
pub async fn handle_key_bindings(
    ...
    match (guard.state.active_tab, key_event.code, key_event.modifiers) {
        ...
        (MenuItem::Bracket, Char('r'), _) => guard.bracket_cycle_region(),
        ...
        (MenuItem::Scoreboard, Char('j') | KeyCode::Down, _) => guard.bracket_game_down(),
        (MenuItem::Scoreboard, Char('k') | KeyCode::Up, _) => guard.bracket_game_up(),
        (MenuItem::Scoreboard, Char('r'), _) => guard.bracket_cycle_region(),
